...
def build_layout():
    ...
    # 2. Main Large Title
st.markdown('<div class="main-title" style="font-family: \'Century Gothic\', \'Futura\', sans-serif; font-weight: bold;">Your next<br>client finder</div>', unsafe_allow_html=True)    
